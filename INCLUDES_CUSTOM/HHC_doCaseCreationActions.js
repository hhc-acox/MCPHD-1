					...
					for(row in sepRules){
						if(sepRules[row][Active]==Yes){
							...
							if(recType.length0){
								...
								if (appMatch && recordAssignment.length0){
									if (appMatch(EnvHealthWQComplaintNA)) {
