function HHC_addAdHocTask(adHocProcess, adHocTask, adHocNote)
{
...
//Optional 5 parameters = WF Comment
	var thisCap = capId;
    ...
    taskObj.setDispositionComment(thisdComment);
