...
function mainProcess() {
	...
	var sql = "SELECT DISTINCT b.b1_per_id1, b.b1_per_id2, b.b1_per_id3 FROM b1permit b INNER JOIN gguidesheet gd ON gd.b1_per_id1 = b.B1_PER_ID1 AND gd.b1_per_id2 = b.B1_PER_ID2 AND gd.b1_per_id3 = b.B1_PER_ID3 AND gd.serv_prov_code = b.serv_prov_code INNER JOIN gguidesheet_item gdi ON gdi.GUIDE_TYPE = gd.GUIDE_TYPE AND gdi.GUIDESHEET_SEQ_NBR = gd.GUIDESHEET_SEQ_NBR AND gdi.SERV_PROV_CODE = gd.SERV_PROV_CODE INNER JOIN ggdsheet_item_asi asi ON asi.GUIDESHEET_SEQ_NBR = gdi.GUIDESHEET_SEQ_NBR AND asi.SERV_PROV_CODE = gdi.SERV_PROV_CODE LEFT JOIN xapp2ref xb ON b.B1_PER_ID1 = xb.B1_PER_ID1 AND b.B1_PER_ID2 = xb.B1_PER_ID2 AND b.B1_PER_ID3 = xb.B1_PER_ID3 AND b.serv_prov_code = xb.serv_prov_code LEFT JOIN b1permit par ON par.B1_PER_ID1 = xb.B1_MASTER_ID1 AND par.B1_PER_ID2 = xb.B1_MASTER_ID2 AND par.B1_PER_ID3 = xb.B1_MASTER_ID3 AND par.serv_prov_code = xb.serv_prov_code WHERE gd.guide_type = 'VC_Larvicide' AND b.serv_prov_code = 'MCPHD' AND asi.asi_name = 'Is Site Breeding' AND asi.ASI_COMMENT IN ('Y', 'Yes') AND b.b1_per_sub_type = 'Complaint' AND b.b1_per_category = 'Larvicide' AND par.b1_per_sub_type IS NULL";
