/*----------------------------------------------------------------------------------------------------------------------/
| Program:  BATCH_WELLFIELD_SITES_TO_SET.js
| Trigger:  BATCH
| Client:   
| Version:  1.0
| Author:   Jake Cox
...
/------------------------------------------------------------------------------------------------------*/
//if (paramsOK){
logMessage("START","Start of Wellfield Site Set Script.");
...
function processRecords(Collection)
{
	...
	aa.set.createSet(setCode,setCode,setType,"Populated 6:00 PM daily via batch script BATCH_WELLFIELD_SITES_TO_SET");
