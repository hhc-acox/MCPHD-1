//ASA;ENVHEALTH!~!~!~ 
//lwacht: 270918: correcting errors that is stopping scripts from committing
areaInspector=false;
//lwacht: 270918: end
...
if(areaInspector){
	...
	iNameResult = aa.person.getUser(areaInspector.toUpperCase());
...
if (matches(appTypeArray[2],'VEH','HSG','SEC','TRA','LHH')) {
	//lwacht: 270918: correcting errors that is stopping scripts from committing
	if(!matches(AInfo['GENERAL.Initial Inspection Date'], "", null, "undefined")){
	//lwacht: 270918: end
...
if (areaInspector == null || areaInspector == 'undefined' || areaInspector == false) {
//lwacht: 270918: emd
